...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        sex = UtilityBelt.readChar("Enter sex:",  "FfMm");
        ...
        //OUTPUT SECTION
String printedCard = Main.formatCard(surname, givenName, category, cardNum, birthCountry, termsAndConditions, sex, uscisNum, dateOfBirth, validDate, expireDate);
...
public static String formatDate(int mounth, int day, int year){
return "";
}
}